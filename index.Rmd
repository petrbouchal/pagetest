...
```{r index-7}
ptrr::register_plexsans("xips", NULL)
ptrr::register_plexsans_condensed("xipsc", NULL)
```
...
ggplot(mtcars, aes(mpg, wt)) +
  geom_point() +
  theme(text = element_text(family = "xips"),
        plot.title = element_text(family = "xipsc", face = "bold")) +
  labs(title = "This is a title 1000999",
       subtitle = "This is a subtitle 1000999")
```
