...
```{r}
sfnts[grepl("([Pp]lex)|(Roboto)", sfnts$family),c("family", "style", "italic", "monospace")]
```
...
systemfonts::register_font("Roboto 2", 
                           plain = '/Users/runner/Library/Fonts/Roboto-Regular.otf')
```
...
ggplot(mtcars, aes(mpg, wt)) +
  geom_point() +
  theme(text = element_text(family = "Roboto 2"),
        plot.title = element_text(family = "Roboto 2")) +
  labs(title = "This is a title 1000999",
       subtitle = "This is a subtitle 1000999")
```
