...
systemfonts::register_font("JBM", 
                           plain = '/Users/runner/Library/Fonts/JetBrainsMono-Regular.ttf')
```
...
ggplot(mtcars, aes(mpg, wt)) +
  geom_point() +
  theme(text = element_text(family = "JBM"),
        plot.title = element_text(family = "JBM")) +
  labs(title = "This is a title 1000999",
       subtitle = "This is a subtitle 1000999")
```
